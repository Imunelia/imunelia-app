(() => {
  ...
  const syncEnglishProducts=()=>{if(fileName!=='produkty-en.html'||document.querySelector('.product-lifestyle'))return;document.body.classList.add('premium-collection-site');loadStylesheet('product-emotion','product-emotion.css?v=20260803-story2');const collection=document.querySelector('#collection');if(!collection)return;const section=document.createElement('section');section.className='product-lifestyle';section.innerHTML='<div class="product-lifestyle-head"><div><p class="section-kicker">Choose by your rhythm</p><h2>Stories begin with everyday care.</h2></div><p>Five clear branches — immunity, energy, performance, recovery and care for the whole family.</p></div><div class="product-lifestyle-grid"><a class="product-lifestyle-card lifestyle-immunity" href="#shield"><span class="product-lifestyle-copy"><strong>Immunity</strong><span>Everyday support for natural resilience.</span><em>View products</em></span></a><a class="product-lifestyle-card lifestyle-energy" href="#flow"><span class="product-lifestyle-copy"><strong>Energy</strong><span>Vitality for active days.</span><em>View products</em></span></a><a class="product-lifestyle-card lifestyle-performance" href="#ultra"><span class="product-lifestyle-copy"><strong>Performance</strong><span>For exceptional physical demand.</span><em>View products</em></span></a><a class="product-lifestyle-card lifestyle-recovery" href="#night"><span class="product-lifestyle-copy"><strong>Recovery</strong><span>Evening calm and renewal.</span><em>View products</em></span></a><a class="product-lifestyle-card lifestyle-family" href="#balance"><span class="product-lifestyle-copy"><strong>For the whole family</strong><span>Everyday care for the people who matter most.</span><em>View products</em></span></a></div>';collection.insertAdjacentElement('beforebegin',section)};

  const applyProductPhotos=async()=>{
    loadStylesheet('product-image-fixes','product-image-fixes.css?v=20260803-story2');
    const local={
      '.lifestyle-energy':'assets/photos/home-story-energy.jpg?v=20260803-story2',
      '#flow':'assets/photos/home-story-energy.jpg?v=20260803-story2',
      '.lifestyle-performance':'assets/photos/home-story-performance.jpg?v=20260803-story2',
      '#ultra':'assets/photos/home-story-performance.jpg?v=20260803-story2',
      '.lifestyle-immunity':'assets/photos/home-story-immunity.jpg?v=20260803-story2',
      '#shield':'assets/photos/home-story-immunity.jpg?v=20260803-story2'
    };
    Object.entries(local).forEach(([selector,url])=>setPhoto(selector,url,'center 46%'));
    await Promise.all([loadScript('family-photo-data','assets/js/family-golden-hour-photo.js?v=20260803-story2'),loadScript('night-photo-data','assets/js/night-premium-evening-photo.js?v=20260803-story2')]).catch(()=>{});
